...
import {
  FaMagic, FaImages, FaTasks, FaChartBar, FaDatabase,
  FaFileAlt, FaUserPlus, FaFileUpload, FaClipboardList, FaCheck
} from "react-icons/fa";
...
const steps = [
  ...
  { number: "3", title: "Set Question Parameters", desc: "Topic, Bloom's Taxonomy, Marks, No of Questions.", icon: FaClipboardList },
